...
let yelpConsumerKey = "f06nnM4grGxEIw-MOwLqGw"
let yelpConsumerSecret = "JtoyLyh6D0IOhyRSbd7Qw0n0g4c"
let yelpToken = "cqfV5B1nDTsTusaiMlN_IwA9Izu5KfGp"
let yelpTokenSecret = "zOFzLOTPZr2pt4G80H6xmX3FnCI"
...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    static var categories:[Dictionary<String,String>] = [
    ...
    func search(with term: String, completion: @escaping ([Business]?, Error?) -> Void) -> AFHTTPRequestOperation {
        return search(with: term, sort: nil, categories: nil, deals: nil,distance:nil,offset:nil,limit:nil, completion: completion)
    }
    
    func search(with term: String, sort: YelpSortMode?, categories: [String]?,deals: Bool?,distance: Int?,offset:Int?,limit:Int?, completion: @escaping ([Business]?, Error?) -> Void) -> AFHTTPRequestOperation {
